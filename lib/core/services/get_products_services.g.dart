...
part of 'get_products_services.dart';
...
class _GetProductsServices implements GetProductsServices {
  _GetProductsServices(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<List<String>> getCategories() async {
    ...
    try {
      _value = _result.data!.map((dynamic i) => i as String).toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
